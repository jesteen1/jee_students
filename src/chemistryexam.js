...
connect.then(()=>{
    console.log("database is connected in chemistry");
     
})
.catch((e)=>{
    console.log("database cannot be connected in chemistry"+e)
...
const chemestryexam = new mongodb.model("chemestryexams",mongodbschema);
module.exports=chemestryexam;
